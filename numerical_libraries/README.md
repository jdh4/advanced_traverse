...
MAGMA is a linear algebra library that is designed for multicore nodes that have GPUs such. It can be thought of as an improvement over LAPACK for the aforementioned hardware.
